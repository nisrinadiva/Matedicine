...
public class AlarmReceiver extends BroadcastReceiver {
    ...
    public static final String TYPE_ONE_TIME = "Get your medicine!";
    public static final String TYPE_REPEATING = "RepeatingAlarm";
    public static final String EXTRA_MESSAGE = "message";
    public static final String EXTRA_TYPE = "type";

    public void setOneTimeAlarm(Context context, int requestCode,String type, String time, String message) {
        ...
        // Periksa apakah waktu yang ditentukan sudah lewat
        if (calendar.before(Calendar.getInstance())) {
            calendar.add(Calendar.DATE, 1); // Tambahkan 1 hari jika sudah lewat
        }
